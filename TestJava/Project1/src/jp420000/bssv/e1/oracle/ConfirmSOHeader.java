...
/**
 * <p>Java class for confirmSOHeader complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="confirmSOHeader"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="detail" type="{http://oracle.e1.bssv.JP420000/}confirmSODetail" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ConfirmSOHeader extends ValueObject {
    ...
    protected List<ConfirmSODetail> detail;
     ...
     * {@link ConfirmSODetail }
     *
     *
     */
    public List<ConfirmSODetail> getDetail() {
        if (detail == null) {
            detail = new ArrayList<ConfirmSODetail>();
        }
        return this.detail;
    }
