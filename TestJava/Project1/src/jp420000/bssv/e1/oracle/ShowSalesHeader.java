...
/**
 * <p>Java class for showSalesHeader complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="showSalesHeader"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="detail" type="{http://oracle.e1.bssv.JP420000/}showSalesDetail" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "showSalesHeader",
         ...
         { "adjustmentScheduleCode", "amountTotalOrderDomestic", "amountTotalOrderForeign", "businessUnit", "company",
           ...
           "shipTo", "soldTo", "stopCode", "taxExplanationCode", "taxRateAreaCode", "userReservedData", "zoneNumber"
    })
public class ShowSalesHeader extends ValueObject {
    ...
    protected List<ShowSalesDetail> detail;
     ...
     * {@link ShowSalesDetail }
     *
     *
     */
    public List<ShowSalesDetail> getDetail() {
        if (detail == null) {
            detail = new ArrayList<ShowSalesDetail>();
        }
        return this.detail;
    }
