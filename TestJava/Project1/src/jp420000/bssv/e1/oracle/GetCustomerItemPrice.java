...
/**
 * <p>Java class for getCustomerItemPrice complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="getCustomerItemPrice"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getCustomerItemPrice",
         propOrder =
         { "agreementID", "businessUnit", "carrier", "currencyCode", "customer", "customerPriceGroupCode",
           "datePriceEffective", "discountTrade", "endUseCode", "freightHandlingCode", "lineOfBusinessCode",
           "modeOfTransportCode", "paymentInstrumentCode", "paymentTermsCode", "priceAdjustmentId", "priceCode1",
           "priceCode2", "priceCode3", "processing", "product", "rateExchange", "routeCode", "statusCodeDuty",
           "stopCode", "transactionQuantity", "unitOfMeasureCodePricing", "unitOfMeasureCodeTransaction", "zoneNumber"
    })
public class GetCustomerItemPrice extends ValueObject {
