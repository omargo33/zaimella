...
public class ShippingConfirmationPortClient {
    public static void main(String[] args) {
        ShippingConfirmationService shippingConfirmationService = new ShippingConfirmationService();
        ShippingConfirmation shippingConfirmation = shippingConfirmationService.getShippingConfirmationPort();

        // Configure credential providers
        Map<String, Object> requestContext = ((BindingProvider) shippingConfirmation).getRequestContext();
