CREATE TABLE "DATA"."T_BT01_RECEPCION_ORDEN_COMPRA" (
    ...
    "USUARIO" VARCHAR2(256 BYTE) NOT NULL ENABLE,
    "USUARIOFECHA" TIMESTAMP (6) NOT NULL ENABLE,
    "VALORTEXTO" VARCHAR2(256 BYTE),
    "VALORNUMERO" NUMBER(12, 0),
    "MODO" VARCHAR2(8 BYTE),
    "COMPANIA" VARCHAR2(8 BYTE),
    "TIPODOCUMENTOCOMPRA" VARCHAR2(8 BYTE),
    "NUMEROORDENCOMPRA" NUMBER(38, 0),
    "FECHA" TIMESTAMP (6),
    "CODIGOPROVEEDOR" NUMBER(8, 0),
    "NOMBREPROVEEDOR" VARCHAR2(256 BYTE),
    "MONEDA" VARCHAR2(8 BYTE),
    "BODEGARECEPCION" VARCHAR2(32 BYTE),
    "CENTROCOSTO" VARCHAR2(32 BYTE),
    "MOTIVO" VARCHAR2(64 BYTE),
    "LINEA" NUMBER(8, 0),
    "CODIGOITEM" NUMBER(8, 0),
    "INDICEITEM" VARCHAR2(32 BYTE),
    "UNIDADMEDIDA" VARCHAR2(8 BYTE),
    "CANTIDADRECIBIDA" NUMBER(12, 4),
    CONSTRAINT "PK_BT01_RECEPCION_ORDEN" PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "APEX_DATA" ENABLE
